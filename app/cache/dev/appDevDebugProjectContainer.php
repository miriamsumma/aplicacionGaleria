...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.item_form' => 'getApp_ItemFormService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\FileUploader A AppBundle\FileUploader instance.
     */
    protected function getApp_BrochureUploaderService()
    {
        return $this->services['app.brochure_uploader'] = new \AppBundle\FileUploader(($this->targetDirs[2].'/../web/uploads/images'));
    }

    /**
     * Gets the 'app.item_form' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Form\ItemType A AppBundle\Form\ItemType instance.
     */
    protected function getApp_ItemFormService()
    {
        return $this->services['app.item_form'] = new \AppBundle\Form\ItemType();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'gallery', 'user' => 'root', 'password' => 'Pepe311', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1fe03978cbe74e998c0972c94f46cc5f23265fbcc8b7432c573fab6f9561d3f9');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('contact_email', 'mfernandez@summa.es');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('574efd20c694f5.15232414')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'contact_email' => 'mfernandez@summa.es',
            'image_directory' => ($this->targetDirs[2].'/../web/uploads/images'),
            ...
            'assetic.ruby.bin' => 'D:\\Programas\\Ruby22-x64\\bin\\ruby.EXE',
            'assetic.sass.bin' => 'D:\\Programas\\Ruby22-x64\\bin\\sass.BAT',
