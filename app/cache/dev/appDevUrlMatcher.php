...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/addItems') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::addItemsAction',  '_route' => 'addItems',);
        }

        // _updateItem
        if (0 === strpos($pathinfo, '/updateItem') && preg_match('#^/updateItem(?:/(?P<item_id>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => '_updateItem')), array (  'item_id' => 1,  '_controller' => 'AppBundle\\Controller\\DefaultController::updateItemAction',));
        }
